...
void garden_seed_add(struct garden *garden, i32 column, enum block_type type, f32 timestamp);
u16 garden_flower_spawn(struct garden *garden, i32 column, enum block_type type, f32 timestamp);
